...
- **THEN** the room names are illustrative examples, not the developer's actual home layout (e.g., no specific combination of Bedroom/Closet/Bathroom/Kitchen/Living room/Study/Hall presented as ground truth)
